namespace ZoomIn.ComponentModel.Mvvm
{
	...
	public static class PropertyObserver
	{
		...
		/// </returns>
		public static IPropertyObserverItem Subscribe<T>(this T source, Expression<Func<T,object>> propertyExpression, Action<T> handlerAction)
			where T : class, INotifyPropertyChanged
		{
			return Subscribe(source, PropertySupport.ExtractPropertyName(propertyExpression), s => handlerAction((T)s));
		}
		...
		/// from the notifications, and <see cref="IPropertyObserverItem.Refresh"/> the notification callback.
		/// </returns>
		public static IPropertyObserverItem Subscribe<T>(this T source, Expression<Func<T, object>> propertyExpression, PropertyChangedEventHandler eventHandler)
			where T : class, INotifyPropertyChanged
		{
